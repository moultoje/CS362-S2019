...
int adventurerFunction(int drawnTreasure, struct gameState *state, int currentPlayer, int cardDrawn, int *tempHand){
...
int councilRoom(int currentPlayer, struct gameState *state, int handPos){
    int i;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
      adventurerFunction(drawntreasure, state, currentPlayer, cardDrawn, temphand);
